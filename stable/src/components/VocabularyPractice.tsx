...
import { LingQ, WordStatus, Lesson, ReaderSettings } from "../types";
...
export default function VocabularyPractice({
  ...
  const activeDeckLanguages = useMemo(() => {
    ...
    Object.entries(lingqs).forEach(([key, lq]) => {
      const isActive = ["1", "2", "3", "4", "5", "learning"].includes(lq.status);
      if (!isActive) return;
