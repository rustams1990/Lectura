...
export interface Lesson {
  ...
  lessonType?: string; // e.g. "youtube" | "book" | "comic" | "article" or custom string
  pinned?: boolean;
...
export interface LessonType {
  id: string;
  name: string;
  icon: string; // e.g. "youtube" | "book" | "comic" | "article" | "music" | "heart" | "star" | "smile" | "compass" | "type"
}
